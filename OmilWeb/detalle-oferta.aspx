<%@ Page Title="" Language="VB" MasterPageFile="~/Master2.master" AutoEventWireup="false" CodeFile="detalle-oferta.aspx.vb" Inherits="detalle_oferta" %>
					...
					<div class="col-sm-10">
						<div class="blog-post blog-single-post">
							...
							<div class="single-post-content">
								...
								<i class="glyphicon glyphicon-chevron-left"></i><a href="ofertas.aspx" target="_self"> volver</a>
							</div>
						</div>
					</div>
					<!-- End Blog Post -->
